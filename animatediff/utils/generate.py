...
from diffusers import AutoencoderKL, DDIMScheduler, DPMSolverMultistepScheduler, KDPM2AncestralDiscreteScheduler
...
def create_pipeline(
    ...
    scheduler = DPMSolverMultistepScheduler.from_config(OmegaConf.to_container(sched_kwargs))
